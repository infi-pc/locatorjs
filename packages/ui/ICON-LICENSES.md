...
- WebStorm is a resized PNG of the official product icon from
  ...
  Copyright © 2026 JetBrains s.r.o. WebStorm and the WebStorm logo are
  trademarks of JetBrains s.r.o.
- The Neovim logo is by Jason Long and licensed under
  [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/).

All product names and marks remain trademarks of their respective owners.
