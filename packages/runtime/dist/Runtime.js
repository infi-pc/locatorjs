  ...
  return (() => {
    ...
    (0, _web.insert)(_el$2, (() => {
      ...
      return () => _c$2() ? (() => {
        ...
        (0, _web.addEventListener)(_el$3, "mouseleave", props.node.type === "component" ? () => setIsHovered(false) : undefined);
        (0, _web.addEventListener)(_el$3, "mouseenter", props.node.type === "component" ? () => setIsHovered(true) : undefined);

        _el$3.style.setProperty("position", "absolute");

        (0, _web.insert)(_el$3, (() => {
          const _c$3 = (0, _web.memo)(() => !!(props.node.type === "component" || props.parentIsHovered), true);

          return () => _c$3() ? (() => {
            const _el$4 = _tmpl$2.cloneNode(true);

            _el$4.style.setProperty("padding", "1px 4px");

            _el$4.style.setProperty("position", "absolute");

            _el$4.style.setProperty("font-size", "12px");

            _el$4.style.setProperty("border-radius", "0px 0px 4px 4px");

            _el$4.style.setProperty("height", "20px");

            _el$4.style.setProperty("white-space", "nowrap");

            (0, _web.insert)(_el$4, () => props.node.name);
            (0, _web.effect)(_p$ => {
              const _v$8 = props.node.type === "component" ? "rgba(0,200,0,0.2)" : "",
                    _v$9 = props.node.type === "component" ? "rgba(50,150,50,1)" : "rgba(150,50,50,1)";

              _v$8 !== _p$._v$8 && _el$4.style.setProperty("background", _p$._v$8 = _v$8);
              _v$9 !== _p$._v$9 && _el$4.style.setProperty("color", _p$._v$9 = _v$9);
              return _p$;
            }, {
              _v$8: undefined,
              _v$9: undefined
        ...
        (0, _web.effect)(_p$ => {
          ...
          _v$ !== _p$._v$ && _el$3.style.setProperty("left", _p$._v$ = _v$);
          _v$2 !== _p$._v$2 && _el$3.style.setProperty("top", _p$._v$2 = _v$2);
          _v$3 !== _p$._v$3 && _el$3.style.setProperty("width", _p$._v$3 = _v$3);
          _v$4 !== _p$._v$4 && _el$3.style.setProperty("height", _p$._v$4 = _v$4);
          _v$5 !== _p$._v$5 && _el$3.style.setProperty("border", _p$._v$5 = _v$5);
          _v$6 !== _p$._v$6 && _el$3.style.setProperty("border-radius", _p$._v$6 = _v$6);
          _v$7 !== _p$._v$7 && _el$3.style.setProperty("z-index", _p$._v$7 = _v$7);
          return _p$;
        }, {
          _v$: undefined,
          _v$2: undefined,
...
function RenderNodeClone(props) {
  ...
  return (() => {
    ...
    _el$5.style.setProperty("box-shadow", "0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1), 0 25px 50px -12px rgb(0 0 0 / 0.25)");

    _el$5.style.setProperty("background", "rgba(255,255,255,1)");

    _el$5.style.setProperty("border-radius", "5px");
    ...
    const _ref$ = myDiv;
    typeof _ref$ === "function" ? _ref$(_el$6) : myDiv = _el$6;
    ...
    (0, _web.effect)(_p$ => {
      ...
      _v$10 !== _p$._v$10 && _el$5.style.setProperty("left", _p$._v$10 = _v$10);
      _v$11 !== _p$._v$11 && _el$5.style.setProperty("top", _p$._v$11 = _v$11);
      _v$12 !== _p$._v$12 && _el$5.style.setProperty("width", _p$._v$12 = _v$12);
      _v$13 !== _p$._v$13 && _el$5.style.setProperty("height", _p$._v$13 = _v$13);
      return _p$;
    }, {
      _v$10: undefined,
      _v$11: undefined,
