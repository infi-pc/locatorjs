...
function setup(props) {
    ...
    if (props.targets) {
        allTargets = Object.fromEntries(Object.entries(props.targets).map(([key, target]) => typeof target === "string"
...
function showOptions() {
    ...
    const options = modal.querySelectorAll(".locatorjs-option input");
