...
function getElementInfo(found) {
  ...
  if (fiber) {
    ...
    const allPotentialComponentFibers = (0, _getAllParentsWithTheSameBoundingBox.getAllParentsWithTheSameBoundingBox)(component); // This handles a common case when the component root is basically the comopnent itself, so I want to go to usage of the component
